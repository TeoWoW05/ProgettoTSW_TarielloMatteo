...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/ProfiloUtente.css">
</head>
<body>
            ...
            <div class="profilo-card">
                ...
                <div class="info-list">
                    <div class="info-row">
                        ...
                        <span class="info-value"><%= utente.getName() %></span>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><%= utente.getNickname() %></span>
                    </div>
            ...
            <div class="profilo-card">
                ...
                <form action="${pageContext.request.contextPath}/ProfiloUtenteServlet" method="post" class="profilo-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="vecchiaPassword" name="vecchiaPassword" placeholder="Inserisci la password attuale">
                    </div>
                    
                    <div class="form-group">
                        <label for="nuovaPassword">Nuova password</label>
                        <input type="password" id="nuovaPassword" name="nuovaPassword" placeholder="Minimo 6 caratteri">
                    </div>
                    
                    <div class="form-group">
                        <label for="confermaPassword">Conferma nuova password</label>
                        <input type="password" id="confermaPassword" name="confermaPassword" placeholder="Ripeti la nuova password">
                    </div>
            ...
            <div class="profilo-card profilo-card-ordini">
                        ...
                        %>
                            <div class="ordine-item">
                                <div class="ordine-header">
                                    <span class="ordine-id">Ordine #<%= ordine.getId() %></span>
                                    <span class="ordine-data"><%= ordine.getDataFormattata() %></span>
                                    <span class="ordine-stato stato-<%= ordine.getStato().toLowerCase().replace(" ", "-") %>">
                                        <%= ordine.getStato() %>
                                    </span>
                                </div>
                                ...
                                <div class="ordine-details">
                                    <div class="ordine-info">
                                        <p><strong>Totale:</strong> <%= ordine.getPrezzoFormattato() %></p>
                                        <p><strong>Indirizzo:</strong> <%= ordine.getIndirizzoCompleto() %></p>
                                        <p><strong>Pagamento:</strong> Carta <%= ordine.getCartaFormattata() %></p>
                                    </div>
                                </div>
                            </div>
                        <%
                ...
                %>
                    <div class="ordini-vuoti">
                        ...
                        <a href="${pageContext.request.contextPath}/ProdottiServlet" class="btn-link">Vai allo shopping</a>
                    </div>
                <%
                }
                %>
